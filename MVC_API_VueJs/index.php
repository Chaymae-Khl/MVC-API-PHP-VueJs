...
include_once ROOT . './controller/profs.php';
...
if ($infos_url[0] != "")
    if (file_exists(ROOT . 'controller/' . $infos_url[0] . ".php")) {
        // $action = "index";
        include_once ROOT . 'controller/' . $infos_url[0] . ".php";
...
echo "URL introuvable 2";
    ...
    echo json_encode("API By Chaymae");
}
